    ...
    return (
        <div className="about-page-container">
            ...
            <section className="relative w-full h-[120vh]">
                ...
                {/* Center Box */}
                <div className="pb-10 relative max-w-7xl mx-auto flex items-center justify-start max-sm:justify-center h-full px-4 max-sm:px-0 max-lg:items-end max-xl:items-end">
