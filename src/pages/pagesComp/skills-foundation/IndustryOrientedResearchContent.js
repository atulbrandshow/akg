...
import { Cpu, Settings, Zap, Beaker, GraduationCap, ArrowRight } from 'lucide-react';
...
export default function IndustryOrientedResearchContent() {
  ...
  return (
    <div className="">
      <div ref={containerRef} className="relative w-full overflow-hidden">
        ...
        <div className="content-header relative mb-12">
          ...
          <div className="absolute top-0 right-0 opacity-[0.03] pointer-events-none"><GraduationCap size={200} className="text-indigo-950" /></div>
        </div>
