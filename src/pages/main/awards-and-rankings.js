...
const awardsData = [
    {
        ...
        description:
            "AKGEC is accredited with the prestigious NAAC A++ Grade, the highest grade awarded for excellence in higher education, reflecting outstanding academic quality, infrastructure, governance, and student outcomes.",
        image: "/image/awards-and-ranking/2026/a1.png",
        year: "2026",
        highlight: true,
    },
    {
        ...
        description:
            "Ajay Kumar Garg Engineering College (AKGEC), Ghaziabad has been honored with the prestigious Diamond Rating by QS I-GAUGE. This recognition highlights our steadfast dedication to academic excellence, innovation, and holistic development across all institutional parameters.",
        image: "/image/awards-and-ranking/2026/a2.png",
        year: "2026",
    },
    {
        id: "2026-a3",
        title: "Green Rankings 2026 – Titanium+ Band",
        description:
            "Ajay Kumar Garg Engineering College (AKGEC) proudly stands among India’s most sustainable institutions, earning recognition in the Titanium+ Band in the Green Rankings 2026 for its accelerated sustainability impact. This prestigious achievement reflects the institute’s strong commitment to environmental responsibility, green campus initiatives, and sustainable practices across academics and operations. By integrating eco-friendly technologies, promoting responsible resource management, and fostering awareness among students and faculty, AKGEC continues to lead as a model institution dedicated to building a greener and more sustainable future.",
        image: "/image/awards-and-ranking/2026/a3.png",
        year: "2026",
    },
    {
        id: "2026-a4",
        title: "QS I-GAUGE Institution of Happiness Award",
        description:
            "In a testament to its vibrant campus life and student-centric philosophy, Ajay Kumar Garg Engineering College (AKGEC), was conferred with the prestigious QS I-GAUGE Institution of Happiness (IOH) Award on December 12, 2025.",
        image: "/image/awards-and-ranking/2026/a4.png",
        year: "2026",
    },
    {
        id: "2026-a5",
        title: "Competition Success Review Ranking",
        description:
            "AKGEC secured top positions in the Competition Success Review Rankings, including Rank 2 in Uttar Pradesh and among Top Engineering Colleges of Super Excellence, showcasing its academic strength, placements, and industry interface.",
        image: "/image/awards-and-ranking/2026/a5.png",
        year: "2026",
    },
    {
        id: "2026-a6",
        title: "THE WEEK – Hansa Research Survey Ranking",
        description:
            "AKGEC achieved remarkable rankings in THE WEEK–Hansa Research Survey 2025, including Best Private Engineering College in Uttar Pradesh, Delhi-NCR, North Zone, and among the top engineering colleges in India.",
        image: "/image/awards-and-ranking/2026/a6.png",
        year: "2026",
    },
    {
        id: "2026-a7",
        title: "Pride of Nation Award 2025",
        description:
            "Ajay Kumar Garg Engineering College was honored with the Pride of Nation Award 2025 as the ‘Best College of Uttar Pradesh’ for excellence in patriotism, leadership, youth empowerment, and nation-building initiatives.",
        image: "/image/awards-and-ranking/2026/a7.png",
        year: "2026",
    },
    {
        id: "2026-a8",
        title: "AICTE Recognition as Nodal Centre",
        description:
            "AKGEC has been recognized by AICTE as a Nodal Centre for Universal Human Values (2025–27) for promoting holistic, value-based education, sustainability, and social responsibility within and beyond the institution.",
        image: "/image/awards-and-ranking/2026/a8.png",
        year: "2026",
    },
    // Old Data
    {
...
export default function AwardsSplitScreen() {
    ...
    const years = ["All", ...new Set(awardsData.map((a) => a.year))].sort((a, b) => b - a);

    // Filtered data
    const filteredAwards = selectedYear === "All" ? awardsData : awardsData.filter((a) => a.year === selectedYear);
    ...
    // Placeholder helper
    const getImgSrc = (src) => src || "https://placehold.co/800x600/003366/FFF?text=Award+Certificate";
        ...
        <div className="bg-white min-h-screen flex flex-col">
            ...
            <section className="max-w-[1600px] mt-8 mx-auto w-full px-4 lg:px-6">
                <div className="text-center">
                    <h1 className="text-3xl md:text-4xl font-novaBold text-brand-blue mb-3">Awards & Ranking</h1>
                    <p className="text-gray-600 font-novaReg text-sm md:text-base max-w-3xl mx-auto leading-relaxed">
                        AKG University continues the legacy of excellence established by Ajay Kumar Garg Engineering
                        College, renowned for its innovation and academic achievements, and industry collaborations. The
                        institution has been consistently recognized for fostering talent, pioneering research, and
                        delivering outstanding student success, making it a leading name in technical education.
                    </p>
                </div>
            </section>
            ...
            <section className="max-w-[1600px] mx-auto w-full px-4 lg:px-6 py-10">
                <motion.div layout className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-3 gap-10">
