    ...
    return (
        <>
            <div className="bg-PaperBackground">
                <Header title={"Placement Policy"} subHeading={"A transparent, fair, and growth-driven approach to career success. 📜✨"} bg="/image/building/building4.webp" gradient={"bg-gradient-to-r from-gray-900 to-transparent"} />
