          ...
          >
            {notifications.map((notification, index) => (
              <SwiperSlide key={index} className=''>
                <p className={`text-center lg:text-right text-white font-novaReg cursor-pointer text-xs`}>{notification}</p>
              </SwiperSlide>
            ))}
          </Swiper>
        </div>
        ...
        <div className='pr-3 xl:pl-20 w-full'> 
          <ul
            className={`${BigMenuToggle
              ...
              : `hidden relative bg-white/30 rounded-xl px-3 xl:px-10`} lg:pt-2 lg:flex items-center justify-between max-2xl:text-sm 2xl:gap-x-6 text-white font-novaSemi`}>
            {BigMenuToggle && <>
              <div className="my-10">
            ...
            <li className="relative group">
              ...
              <div
                className={`${BigMenuToggle ? "relative w-full " : "absolute w-max"
                  } ${openMenu === 'about' && "absolute h-auto mt-0 w-full"} left-0 h-0 mt-2 mb-5 overflow-hidden lg:group-hover:h-auto lg:group-hover:mt-0 transition-all bg-white text-black rounded-lg shadow-lg `}
              >
            ...
            <li className="group">
              ...
              <div
                className={`${BigMenuToggle ? "relative w-full " : "absolute w-[1100px]"
            ...
            <li className="group">
              ...
              <div
                className={`${BigMenuToggle ? "relative w-full" : "absolute w-[1050px]"
              ...
              >
                <div className="grid grid-cols-6">
                      ...
                      <div className="h-full">
                        <div className="relative z-10 p-4 lg:p-6 text-white">
                          <div className="grid grid-cols-2 gap-2 lg:gap-4 mt-3">
                            <div className="bg-indigo-950 w-28 lg:w-36 px-5 py-4 rounded-md flex flex-col items-center text-center">
                              <h3 className="text-2xl lg:text-3xl font-novaBold">19K+</h3>
                              <p className="text-xs font-novaLight">Students Graduated</p>
                            </div>
                            <div className="bg-indigo-950 w-28 lg:w-36 px-5 py-4 rounded-md flex flex-col items-center text-center">
                              <h3 className="text-2xl lg:text-3xl font-novaBold">8</h3>
                              <p className="text-xs font-novaLight">Departmental Research Groups</p>
                            </div>
                            <div className="bg-indigo-950 w-28 lg:w-36 px-5 py-4 rounded-md flex flex-col items-center text-center">
                              <h3 className="text-2xl lg:text-3xl font-novaBold">213</h3>
                              <p className="text-xs font-novaLight">Students in Univ. Merit List</p>
                            </div>
                            <div className="bg-indigo-950 w-28 lg:w-36 px-5 py-4 rounded-md flex flex-col items-center text-center">
                              <h3 className="text-2xl lg:text-3xl font-novaBold">2000+</h3>
                  ...
                  <div className="col-span-4 max-md:col-span-6 p-5 transition-all max-md:max-h-72 max-md:overflow-y-scroll max-md:flex-col">
