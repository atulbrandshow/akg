...
const DepartmentList = () => {
  ...
  const LoadingSpinner = () => (
    <div className="flex items-center justify-center h-64">
      ...
      <span className="ml-3 text-gray-600 font-medium">Loading departments...</span>
    </div>
  )
    ...
    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <div className="flex items-center mb-2">
              <h3 className="text-xl font-bold text-gray-800 mr-3">{department.name}</h3>
            ...
            <div className="flex items-center text-gray-600 mb-3">
              ...
              <span className="text-sm font-medium">{department.school?.name || "No school assigned"}</span>
            </div>
          </div>
          <div
        ...
        {department.programsOffered && department.programsOffered.length > 0 && (
          <div className="mb-4">
            <div className="text-sm font-medium text-gray-700 mb-2">Programs Offered:</div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-100">Manage and monitor all academic departments</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
                  ...
                  <tr key={department._id} className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="flex items-center">
                            <div className="text-sm font-semibold text-gray-900 mr-2">{department.name}</div>
                            <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full">
                              {department.departmentCode}
                            </span>
                          </div>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900">{department.school?.name || "Not assigned"}</td>
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-1">
                      ...
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full mr-1.5 ${
                            department.status ? "bg-green-400" : "bg-red-400"
                          }`}
                        ></span>
                        {department.status ? "Active" : "Inactive"}
                      </span>
