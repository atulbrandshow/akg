        ...
        <div className="col-span-12">
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-10">
            ...
            <p className="text-gray-600 mb-8 font-novaReg">
              Under the ASF umbrella, the following 14 Centres of Excellence
              (COEs) are operational, providing state-of-the-art training and
              research facilities in collaboration with eminent industry
              partners:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {coes.map((coe, index) => (
                <div
                  key={index}
                  className="flex items-start gap-4 p-4 rounded-xl bg-indigo-50 border border-indigo-100 hover:border-secondary transition-colors group"
                >
