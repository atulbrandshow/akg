  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 left-16 w-72 h-40 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/60 p-5 transform -rotate-2 hover:rotate-0 transition-transform duration-500">
