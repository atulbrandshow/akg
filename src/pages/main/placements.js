...
const slides = [
    ...
    },
    {
        ...
        heading: (
            <>
                Bridging the gap <br /> between campus and corporate
            </>
        ),
    ...
    },
    {
        ...
        heading: (
            <>
                Excellence in every <br /> step of the journey
            </>
        ),
                    ...
                    <div className="mx-auto max-w-2xl lg:max-w-none">
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-lg/8 font-novaReg text-gray-600">
                                Our students secure top positions in leading companies worldwide, achieving remarkable
                                career success.
                            </p>
                        </div>
                        <dl className="mt-10 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-4">
                            {stats.map((stat) => (
                                <div key={stat.id} className="flex flex-col bg-blue-500 p-8">
                                    ...
                                    <dd className="order-first text-4xl font-novaBold tracking-tight text-white">
                                        {stat.value}
                                    </dd>
                                </div>
                            ))}
                            ...
                            {slides?.map((student, index) => (
                                <SwiperSlide key={index}>
                                    <div className="my-10 text-center flex flex-col items-center mx-10 max-sm:mx-5">
                                        ...
                                        <p className="max-w-3xl max-md:text-sm font-novaReg text-justify leading-relaxed">
                                            {student.description}
                                        </p>
                                        <div className="flex flex-col items-center mt-10">
                                            ...
                                            <div className="mt-4 uppercase text-center">
                                                ...
                                                <small className="font-novaSemi text-yellow-400">
                                                    {student.company}
                                                </small>
                                            </div>
                                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div className="text-center">
                            <h4 className="text-black font-novaBold text-xl mb-5">
                                SEE HOW AKG UNIVERSITY <br /> STUDENTS PREPARE AND BAG RS. 1.7 CR INTERNATIONAL <br />{" "}
                                PLACEMENTS AT TOP COMPANIES!
                            </h4>
                            <div className="flex justify-center">
                                <div className="relative bg-white rounded-lg overflow-hidden shadow-lg">
                                    <img
                                        src="/image/building/building4.webp"
                                        alt="thumbnail"
                                        className="w-full h-full object-cover"
                                    />
                    ...
                    <div className="px-3 flex items-center max-lg:w-full justify-start h-full ml-auto bg-brand-blue/90 w-1/2 min-h-[600px]">
                        <div className="p-20 max-md:p-10 max-w-2xl">
                            ...
                            <div className="space-y-4 text-white font-novaReg leading-relaxed text-justify">
                                <p>
                                    Ajay Kumar Garg University (AKGU) maintains a strong focus on career development and
                                    industry engagement to ensure excellent placement opportunities for its students.
                                    The University’s Training and Placement Cell actively collaborates with leading
                                    national and multinational companies to facilitate campus recruitment across diverse
                                    disciplines.
                                </p>
                                <p>
                                    Through structured training programs, industry interactions, internships, workshops,
                                    and skill development initiatives, students are well-prepared to meet the evolving
                                    demands of the professional world. The placement process is supported by continuous
                                    aptitude training, technical skill enhancement, and personality development
                                    sessions.
                                </p>
                                <p>
                                    Over the years, AKGU has built strong relationships with reputed organizations
                                    across sectors such as information technology, consulting, finance, core
                                    engineering, and emerging technologies. The University consistently records
                                    commendable placement outcomes, with many students securing positions in prestigious
                                    companies with competitive salary packages.
                                </p>
                                <p>
                                    With a commitment to bridging academia and industry, AKG University strives to equip
                                    students with the knowledge, skills, and professional ethics required to succeed in
                                    a global career landscape.
                                </p>
                            </div>
                            <div className="mt-8">
                                <Button
            ...
            <section className="pt-20">
                <div className="relative w-full max-w-7xl mx-auto px-3 overflow-hidden">
                    ...
                    <p className="text-center md:text-lg font-novaReg mx-10 lg:mx-36 text-gray-600">
                        At AKG University, we are committed to student success, empowering individuals to thrive
                        academically, socially, and professionally. Through exceptional learning experiences and
                        comprehensive support services, we inspire our students to reach their fullest potential.
                    </p>
                    <StudentStories />
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-3">
                <div className="py-12">
                    <div className="container mx-auto px-4">
                        <h2 className="text-4xl font-novaSemi text-center text-brand-blue mb-8">
