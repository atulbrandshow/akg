    ...
    <div className="w-full">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 rounded-2xl p-6 mb-8 shadow-2xl">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-novaBold text-white tracking-wide">Create Event</h1>
            <p className="text-blue-100 font-novaReg text-sm mt-1">Add a event page to your website structure</p>
          </div>
        </div>
      </div>
      {!showPageDetails && (
