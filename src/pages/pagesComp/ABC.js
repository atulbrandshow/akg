...
const ABC = () => {
    const videos = [
        ...
        {
            id: "video2",
            title: "Academic Bank of Credits: What is ABC-Video-1",
            videoId: "tDSNKZWXs7E",
            duration: "2:31",
        },
        {
            id: "video3",
            title: "Academic Bank of Credits: What is ABC-Video-2",
            videoId: "X_JXB1U09ZY",
            duration: "2:15",
        },
        {
            id: "video4",
            title: "Academic Bank of Credits: What is ABC-Video-3",
            videoId: "bvR8vgEalz8",
            duration: "2:42",
        },
    ];
    ...
    return (
        <section>
            <div className="max-w-[1400px] mx-auto px-6 max-sm:px-2 py-10 grid grid-cols-1 lg:grid-cols-2  gap-5">
                <div className="pr-5">
                    <h1 className="text-4xl max-lg:text-3xl max-sm:text-2xl max-sm:font-novaSemi font-novaReg mb-4">
                        Academic Bank of Credits (ABC)
                    </h1>
                    <p className="text-gray-700 max-[400px]:text-sm mb-6">
                        AKG University offers students the flexibility and freedom to design their own academic journey
                        through the
                        <strong> Academic Bank of Credit (ABC)</strong> system. This innovative, government-backed
                        digital platform allows students to earn, store, and transfer academic credits securely across
                        multiple recognized institutions. By embracing ABC, AKG University empowers learners to pursue
                        interdisciplinary studies, resume education after breaks, and complete their degrees at their
                        own pace, aligning with the vision of a modern, student-centric education.
                    </p>
          ...
          <ul className="list-disc pl-5 space-y-2 max-[400px]:text-sm text-gray-700 mb-4">
            ...
            <li><strong>Choice-Based Learning:</strong> You can choose courses based on your interests, making your education more enjoyable and tailored to your ambitions.</li>
                    ...
                    <h2 className="text-2xl font-novaReg mb-2">
                        Benefits of Academic Bank of Credit (ABC) at AKG University
                    </h2>
                    <ul className="list-disc pl-5 space-y-2 max-[400px]:text-sm text-gray-700 mb-4">
                        <li>Allows students to accumulate and redeem credits across multiple institutions.</li>
                        <li>
                            Facilitates seamless credit transfer for course mobility and interdisciplinary learning.
                        </li>
                        <li>Supports multiple entry and exit points, enabling flexible pacing of education.</li>
                        <li>Enhances employability through alignment with industry and evolving education trends.</li>
                        <li>Provides transparent, digitally secure, and verifiable academic records.</li>
                        <li>Encourages lifelong learning and continuous skill development.</li>
                        <li>Reduces administrative burden through automated credit management.</li>
                        <li>
                            Enables partnerships with other ABC-registered institutions for expanded learning options.
                        </li>
                    </ul>

                    <p className="text-gray-700 max-[400px]:text-sm">
                        By implementing <strong>ABC</strong>, AKG University reinforces its commitment to innovation,
                        inclusivity, and empowering students to take charge of their educational and professional
                        futures.
                    </p>
                </div>
                <div className="">
                    ...
                    <div className="mt-5">
                        <ul className="list-disc pl-10 space-y-2 font-novaReg text-blue-700">
                            <li>
                                <Link
                                    className="hover:underline font-novaReg text-blue-700"
                            ...
                            <li>
                                <Link
                                    className="hover:underline font-novaReg text-blue-700"
                                    href="/pdf/abc/Academic-Bank-of-Credits_User_Manual_V3.pdf"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    <strong className="text-[#17018b]">User Manual:</strong> Student Registration and
                                    Credit Transfer under ABC
                                </Link>
                            </li>
                        </ul>
                    </div>
