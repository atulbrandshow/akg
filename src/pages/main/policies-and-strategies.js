  ...
  return (
    <>
      <div className="bg-[#f2f6ff]">
        <Header title={"Policies And Strategies"} bg="/image/tech-invent-&-events/tech-invent-banner.jpg" Button={{ name: "Apply Now", Link: "/" }} gradient={"bg-gradient-to-r from-gray-900 to-transparent"} />
