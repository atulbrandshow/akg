      ...
      <main className='max-w-[1400px] max-[1450px]:container mx-auto py-10 px-10 max-sm:px-2'>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div>
              <h2 className="text-3xl font-novaReg">Artificial Intelligence & Machine Learning</h2>
              <p className="my-5 tracking-tight font-novaReg text-start leading-5">
                The Department of Artificial Intelligence & Machine Learning at AKGU was established to meet the growing demand for AI professionals. We provide a cutting-edge learning environment that combines theoretical foundations with practical applications in AI/ML, supported by world-class research facilities.
              </p>
              <p className="leading-5 text-start font-novaReg">
                Our department has quickly become a hub for innovation in machine learning, deep learning, and intelligent systems. We offer comprehensive support to M.Tech. scholars through specialized AI lab facilities, access to high-performance computing resources, and guidance from faculty with industry and research expertise. Our faculty and students regularly publish research in top-tier AI conferences (NeurIPS, ICML, CVPR) and journals, with particular strengths in computer vision, natural language processing, and reinforcement learning.
              </p>
            </div>
            <div>
              <h2 className='font-novaReg text-2xl'>Scope</h2>
              <p className='mt-2 font-novaReg'>According to a McKinsey report, AI adoption has more than doubled since 2017, with 50% of companies now using AI in at least one business function. The global AI market is projected to grow at a CAGR of 38.1% from 2022 to 2030, creating unprecedented demand for skilled AI/ML professionals across all sectors.</p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-2xl font-novaReg text-gray-800 mb-2">
              AKG University B.Tech AI & ML Admission Eligibility & Fees
            </h1>
            <p className="text-gray-800 font-novaReg">
              Applicants must have completed 10+2 with Mathematics as compulsory subject along with Physics/Computer Science/Statistics, securing at least 65% aggregate marks. Strong aptitude in quantitative subjects and programming is preferred.
            </p>
          </div>
          <div className="space-y-6">
            <div>
              <table className="w-full border border-gray-300 border-collapse">
                ...
                <tbody>
                  <tr className="border-b font-novaReg">
                    ...
                    <td className="py-3 px-4 text-gray-700">145000/- INR</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="w-full border border-gray-300 border-collapse">
                ...
                <tbody>
                  <tr className="border-b font-novaReg">
                    ...
                    <td className="py-3 px-4 text-gray-700">4500/- INR</td>
                  </tr>
                  <tr className="border-b font-novaReg">
                    <td className="py-3 px-4 text-gray-700">AI Lab Security Deposit</td>
                    <td className="py-3 px-4 text-gray-700">5000/- INR</td>
                  </tr>
                  <tr className="border-b font-novaReg">
                    <td className="py-3 px-4 text-gray-700">Cloud Computing Access Fee</td>
                    <td className="py-3 px-4 text-gray-700">8000/- INR</td>
                  </tr>
                </tbody>
              </table>
            </div>
