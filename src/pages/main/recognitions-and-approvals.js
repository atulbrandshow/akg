      ...
      >
        ...
        <div className="relative z-20 max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 flex items-center lg:items-start">
          <div className="max-w-2xl w-full space-y-8 lg:space-y-10">
            ...
            <div className="naac-text space-y-4">
              <p className="text-lg sm:text-xl lg:text-2xl xl:text-2.5xl text-white font-medium leading-relaxed font-novaReg max-w-lg lg:max-w-xl tracking-wide drop-shadow-lg shadow-black/50">
                AKG University is a fully established institution under the UP
                State Legislature and is recognized by the{" "}
                <span className="text-yellow-300 font-bold drop-shadow-md">
                  University Grants Commission (UGC)
                </span>{" "}
                under Section 2(f) of the UGC Act, 1956. The university holds
                the prestigious{" "}
                <span className="text-yellow-200 font-bold text-2xl drop-shadow-2xl">
                  NAAC A++ accreditation
                </span>
                , placing it among the top engineering colleges in Uttar
                Pradesh.
              </p>
            </div>

            {/* Fixed: High contrast buttons */}
            <div className="naac-buttons flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-12">
                ...
                {/* <div className="col-span-1 lg:col-span-4 lg:col-start-4">
                    ...
                    <p className="text-lg text-slate-700 mb-8 opacity-90 leading-relaxed">
                      For any information regarding accreditations and
                      approvals:
                    </p>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:gap-5">
                      <div className="group flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl hover:shadow-md hover:-translate-y-1 transition-all border border-blue-100/50 hover:border-blue-200">
                        ...
                        <div className="min-w-0">
                          <span className="block text-sm font-semibold text-slate-700 uppercase tracking-wide mb-1">
                            Accreditation Cell
                          </span>
                          <a
                            href="tel:+917290034978"
                            className="font-bold text-lg text-slate-900 hover:text-blue-600 transition-colors block"
                          >
                            +91-7290034978
                          </a>
                        </div>
                      ...
                      <div className="group flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl hover:shadow-md hover:-translate-y-1 transition-all border border-blue-100/50 hover:border-blue-200">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <a
                            href="mailto:accreditation@akgec.ac.in"
                            className="font-bold text-lg text-slate-900 hover:text-blue-600 transition-colors block truncate"
                          >
              ...
              >
                ...
                <div className="w-24 h-24 mx-auto mb-8 bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl flex items-center justify-center shadow-2xl group-hover:shadow-blue-500/25 group-hover:scale-110 transition-all duration-500 ring-4 ring-white ring-opacity-50">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zM12.962 2.144a2.066 2.066 0 00-1.2.468 2.066 2.066 0 00-.481 1.2c.029.151.051.303.076.45a11.96 11.96 0 000 2.694 2.066 2.066 0 00.481 1.2 2.066 2.066 0 001.2.468 2.066 2.066 0 001.193-.431 2.066 2.066 0 00.466-1.192 11.96 11.96 0 000-2.696 2.066 2.066 0 00-.466-1.192 2.066 2.066 0 00-1.193-.468zm-6.924 10.712a2.066 2.066 0 00-1.2-.468 2.066 2.066 0 00-1.193.431 2.066 2.066 0 00-.466 1.192 11.96 11.96 0 000 2.696 2.066 2.066 0 00.466 1.192 2.066 2.066 0 001.193.468 2.066 2.066 0 001.2-.468 2.066 2.066 0 00.481-1.2 11.96 11.96 0 000-2.694 2.066 2.066 0 00-.481-1.2zm10.689-4.222a2.066 2.066 0 00-1.2.468 2.066 2.066 0 00-.481 1.2c.029.151.051.303.076.45a11.96 11.96 0 010 2.694 2.066 2.066 0 00.481 1.2 2.066 2.066 0 001.2.468 2.066 2.066 0 001.193-.431 2.066 2.066 0 00.466-1.192 11.96 11.96 0 000-2.696 2.066 2.066 0 00-.466-1.192 2.066 2.066 0 00-1.193-.468z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-lg lg:text-xl text-slate-700 font-semibold leading-relaxed max-w-3xl mx-auto px-6">
                    These accreditations and approvals reflect our supreme
                    standing in technical and professional education, validated
                    by India's most prestigious statutory bodies.
                  </p>
                </div>
