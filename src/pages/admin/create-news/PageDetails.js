...
export default function PageDetailsForm({ allData, parentPage }) {
  ...
  const [componentType, setComponentType] = useState("news-details");
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-novaBold text-gray-900">Add News Details</h1>
                <p className="text-gray-600 font-novaReg mt-2">Create and configure your news content with all necessary details</p>
              </div>
