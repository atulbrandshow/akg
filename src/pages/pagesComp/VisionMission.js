    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div
            ref={missionRef}
            className="group relative z-10 bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.05] hover:-translate-y-2 overflow-hidden border-2 border-primary/20 hover:border-primary/40 transform-gpu perspective-1000"
            style={{
              ...
              <div className="space-y-5 font-novaReg">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">D</span>eliver exceptional education across engineering,
                        management, law, health sciences, liberal arts, and
                        emerging areas.
                      </p>
                    </div>
                  </div>
                ...
                <div className="group/item relative bg-gradient-to-r from-blue-50/30 to-transparent p-5 rounded-2xl hover:from-blue-100/50 hover:to-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border border-primary/10 hover:border-primary/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">F</span>oster industry engagement, research,
                        entrepreneurship, and practical skills through
                ...
                <div className="group/item relative bg-gradient-to-r from-blue-50/30 to-transparent p-5 rounded-2xl hover:from-blue-100/50 hover:to-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border border-primary/10 hover:border-primary/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">P</span>rioritize student-centric, inclusive approaches for
                        lifelong learning and meaningful societal impact.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group/item relative bg-gradient-to-r from-blue-50/30 to-transparent p-5 rounded-2xl hover:from-blue-100/50 hover:to-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border border-primary/10 hover:border-primary/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">C</span>hampion global standards, diversity, and sustainable
      ...
      <div className="absolute inset-0">
        {/* Top right card overlay */}
        <div className="absolute -top-4 -right-28 w-80 h-48 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/60 p-6 transform rotate-3 hover:z-[100] hover:rotate-1 transition-transform duration-500">
          <div className="flex items-center justify-between mb-4">
            <div className="text-sm font-semibold text-primary">
              AKG University
            </div>
