...
const PlacementHighlightsTable = () => {
    ...
    const icons = {
        ...
        salary: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 2a10 10 0 1 1-10 10A10 10 0 0 1 12 2zM7 7h10M7 12h10m-10 5l8.5 8M7 17h3c6.667 0 6.667-10 0-10" /></svg>,
