            ...
            <div className="border-2 border-dashed border-gray-300 hover:border-blue-400 transition-colors rounded-lg p-6 text-center bg-gray-50 hover:bg-gray-100">
                <div className="space-y-2">
                    ...
                    <div className="text-sm text-gray-600">
                        ...
                        <p className="text-xs text-gray-500 mt-1 font-novaReg">WebP format recommended</p>
                        {dimensions && <p className="text-xs text-gray-500 font-novaReg">Dimensions: {dimensions}</p>}
                    </div>
                </div>
                <input type="file" id={id} accept={accept} onChange={onChange} className="hidden" />
                <label
                    htmlFor={id}
                    className="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-novaReg rounded-lg hover:bg-blue-700 cursor-pointer transition-colors"
                >
...
// Compact File Upload for Parameters
const CompactFileUpload = ({ id, file, existingImage, onChange, onDelete }) => {
    return (
        <div className="space-y-2">
            <div className="relative">
                <input type="file" accept="image/webp" onChange={onChange} className="hidden" id={id} />
                <label
                    htmlFor={id}
                    className="w-full inline-flex items-center justify-center px-3 py-2 border font-novaReg border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 cursor-pointer transition-colors"
                >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
                            strokeLinecap="round"
                    ...
                    {file || existingImage ? "Change" : "Choose"}
                </label>
            </div>
            <ImagePreview file={file} existingImage={existingImage} onDelete={onDelete} label="Parameter Image" />
        </div>
    )
}
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-600 mt-2 font-novaReg">Update and modify your {type.toLowerCase()} content with all necessary details</p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 border font-novaReg border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    className="w-full px-3 py-2 border font-novaReg border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                            ...
                                            <div>
                                                ...
                                                <CompactFileUpload
                                                    ...
                                                    existingImage={formData[`existing_param_img${paramIndex}`]}
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-600 mt-1 font-novaReg">Review all changes before updating the circular</p>
                            </div>
                            <div className="flex items-center space-x-4">
                                <button
                                    type="button"
