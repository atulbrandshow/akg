...
import { Target, CircleCheckBig, Lightbulb, Eye, Compass } from "lucide-react";
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="absolute -bottom-16 -left-32 w-72 h-40 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/60 p-5 transform -rotate-2 hover:rotate-0 hover:scale-105 hover:-translate-y-4 z-10 hover:z-[100] transition-all duration-500 group">
          ...
          <div
            ref={missionRef}
            className="group relative z-10 bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-[1.08] hover:-translate-y-3 overflow-hidden border-2 border-primary/20 hover:border-primary/40 transform-gpu perspective-1000"
            style={{
          ...
          >
            ...
            <div className="absolute left-0 top-0 w-1 h-32 bg-secondary"></div>
            <div className="absolute right-0 bottom-0 w-1 h-32 bg-secondary"></div>
              ...
              <div className="space-y-5 font-novaReg">
                <div className="group/item relative bg-gradient-to-r from-blue-50/30 to-transparent p-5 rounded-2xl hover:from-blue-100/50 hover:to-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border border-primary/10 hover:border-primary/30">
                  <div className="flex items-start gap-4">
                    <CircleCheckBig className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">D</span>eliver
                        exceptional education across engineering, management,
                        law, health sciences, liberal arts, and emerging areas.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group/item relative bg-gradient-to-r from-blue-50/30 to-transparent p-5 rounded-2xl hover:from-blue-100/50 hover:to-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border border-primary/10 hover:border-primary/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">F</span>oster
                        industry engagement, research, entrepreneurship, and
                        practical skills through internships and placements.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group/item relative bg-gradient-to-r from-blue-50/30 to-transparent p-5 rounded-2xl hover:from-blue-100/50 hover:to-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border border-primary/10 hover:border-primary/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">P</span>rioritize
                        student-centric, inclusive approaches for lifelong
                        learning and meaningful societal impact.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group/item relative bg-gradient-to-r from-blue-50/30 to-transparent p-5 rounded-2xl hover:from-blue-100/50 hover:to-primary/10 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg border border-primary/10 hover:border-primary/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed group-hover/item:text-gray-900 transition-colors duration-300">
                        <span className="font-bold text-2xl">C</span>hampion
                        global standards, diversity, and sustainable development
          ...
          <div className="absolute inset-0">
            {/* Top right card overlay */}
            <div className="absolute -top-4 -right-28 w-80 h-48 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/60 p-6 transform rotate-3 hover:rotate-1 transition-transform duration-500">
              <div className="flex items-center justify-between mb-4">
                <div className="text-sm font-semibold text-primary">
                  AKG University
                </div>
          ...
          >
            ...
            <div className="absolute left-0 top-0 w-1 h-32 bg-primary"></div>
            <div className="absolute right-0 bottom-0 w-1 h-32 bg-primary"></div>
              ...
              <div className="flex justify-center items-center min-h-[280px]">
                <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-yellow-50/50 to-orange-50/50 group-hover:from-yellow-100/50 group-hover:to-orange-100/50 transition-all duration-300">
                  <p className="text-gray-700 font-novaReg text-xl leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                    <span className="font-bold text-2xl">T</span>o empower
                    innovative leaders through transformative education,
                    cutting-edge research, and ethical practices for a
